((python-mode . ((eval . (blacken-mode -1))))
 (dap-register-debug-template
  ...
  (list :type "python"
        :args " -t model_train -b 1 -e 2 -n residue --target_dataset abag_affinity_of_embeddings:absolute --validation_size 1 --gnn_type identity --pretrained_model IPA --aggregation_method interface_sum"
        :cwd nil
        :module nil
