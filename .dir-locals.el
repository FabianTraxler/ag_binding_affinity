...
(dap-register-debug-template
 ...
 (list :type "python"
       :args " -t model_train -b 2 -e 2 -n residue --target_dataset abag_affinity_of_embeddings:absolute --validation_size 1 --gnn_type identity --pretrained_model IPA --aggregation_method sum"
       :cwd nil
       :module nil
